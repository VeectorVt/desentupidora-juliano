import { Truck, MessageCircle, Phone, Mail, MapPin, CheckCircle, Leaf } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 sm:gap-12">
          ...
          <div>
            <div className="flex items-center gap-3 mb-5">
              ...
              <div>
                <span className="text-white font-extrabold text-lg leading-tight block">Desentupidora</span>
                <span className="text-orange-400 font-bold text-base leading-tight block -mt-0.5">Juliano</span>
              </div>
            </div>
      ...
      <div className="border-t border-white/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <p className="text-white/30 text-sm text-center">
            © {currentYear} Desentupidora Juliano. Todos os direitos reservados.
          </p>
        </div>
      </div>
    </footer>
